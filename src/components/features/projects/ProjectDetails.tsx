...
const ProjectDetails: React.FC<ProjectDetailsProps> = ( { project, onClose, parentRef } ) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50">
            {/* Left (50%) - Details */ }
            <div className="relative w-1/2" style={ { height } }>
                {/* Nội dung chính */ }
                <div className="bg-gray-900 rounded-l-2xl h-full p-6 overflow-y-auto shadow-lg border-r border-purple-700/20">
                    <div className="space-y-3 text-sm leading-relaxed">
                        {/* Tiêu đề + Duration */ }
                        <ProjectTitle project={ project } onClose={ onClose }/>
